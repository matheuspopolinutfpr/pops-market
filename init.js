...
print("Vendedores: " + db.vendedores.countDocuments() + " documentos");
print("Produtos: " + db.produtos.countDocuments() + " documentos");
print("Clientes: " + db.clientes.countDocuments() + " documentos");
print("Pedidos: " + db.pedidos.countDocuments() + " documentos");
print("Carrinhos: " + db.carrinhos.countDocuments() + " documentos");
print("Avaliacoes: " + db.avaliacoes.countDocuments() + " documentos");
